...
//定义引脚
int Left_motor_go = 23;       //左电机前进AIN2连接Raspberry的wiringPi编码28口
int Left_motor_back = 24;     //左电机后退AIN1连接Raspberry的wiringPi编码29口

int Right_motor_go = 21;      //右电机前进BIN2连接Raspberry的wiringPi编码24口
int Right_motor_back = 22;    //右电机后退BIN1连接Raspberry的wiringPi编码25口

int Left_motor_pwm = 13;      //左电机控速PWMA连接Raspberry的wiringPi编码27口
// 19
int Right_motor_pwm = 5;     //右电机控速PWMB连接Raspberry的wiringPi编码23口
// 6
...
const int TrackSensorLeftPin2  =  2;  //定义左边第二个循迹红外传感器引脚为wiringPi编码21口
